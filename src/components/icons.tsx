...
import gs_img from '@/img/history.svg'
import bi_img from '@/img/bio.svg'
import ak_img from '@/img/geography.svg'
import la_img from '@/img/oude_taal1.svg'
import mu_img from '@/img/muziek.svg'
import ot_img from '@/img/anders.svg'
import gl_img from '@/img/gl.svg'
import gr_img from '@/img/oude_taal2.svg'
import ckv_img from '@/img/ckv.svg'
import es_img from '@/img/es.svg'
